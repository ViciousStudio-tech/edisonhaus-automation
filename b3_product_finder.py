...
EdisonHaus theme: Pet Home Accessories. All products must fit this theme.
...
# ── Pet Home Accessories Theme Definition (auto-generated by phase4_pipeline_lockdown) ──
# Locked to theme: Pet Home Accessories
# CJ Category: Pet Supplies > Furniture
# Generated: 2026-03-13T17:21:01.011093

NICHES = [
    {
        "name": "pet beds & furniture",
        "search_terms": ["pet bed", "cat bed", "dog bed", "pet sofa", "cat tree", "pet house"],
        "collection_id": 305042358346,
        "collection_handle": "Comfort & Rest",
        "reject_keywords": ["earring", "jewelry", "car part", "laptop", "phone case", "human"],
    },
    {
        "name": "pet bowls & feeders",
        "search_terms": ["pet bowl", "dog bowl", "cat feeder", "automatic pet feeder", "water fountain pet", "slow feeder dog"],
        "collection_id": 305042325578,
        "collection_handle": "Feeding & Dining",
        "reject_keywords": ["earring", "jewelry", "car part", "laptop", "phone case", "human"],
    },
    {
        "name": "pet toys & play",
        "search_terms": ["pet toy", "dog toy", "cat toy", "interactive pet toy", "chew toy", "catnip toy"],
        "collection_id": 305042391114,
        "collection_handle": "Play & Entertainment",
        "reject_keywords": ["earring", "jewelry", "car part", "laptop", "phone case", "human", "baby toy"],
    },
    {
        "name": "pet storage & organization",
        "search_terms": ["pet food container", "dog treat jar", "pet supply organizer", "leash holder", "pet toy basket"],
        "collection_id": 305042423882,
        "collection_handle": "Storage & Organization",
        "reject_keywords": ["earring", "jewelry", "car part", "laptop", "phone case"],
    },
    {
        "name": "pet grooming",
        "search_terms": ["pet brush", "dog grooming", "cat brush", "pet nail clipper", "pet shampoo", "deshedding tool"],
        "collection_id": 305042489418,
        "collection_handle": "Grooming & Care",
        "reject_keywords": ["earring", "jewelry", "car part", "laptop", "phone case", "human hair"],
    },
    {
        "name": "pet safety & travel",
        "search_terms": ["pet carrier", "dog harness", "pet car seat", "pet gate", "dog leash", "pet GPS tracker"],
        "collection_id": 305042456650,
        "collection_handle": "Safety & Security",
        "reject_keywords": ["earring", "jewelry", "laptop", "phone case"],
    },
]

FEATURED_COLLECTION_ID = 305042358346  # Default featured
...
# ── Claude AI scoring ──────────────────────────────────────────────────────────
BRAND_BRIEF = """
EdisonHaus is a Shopify store specializing in Pet Home Accessories.
The brand vibe: stylish, functional pet home accessories that complement modern home decor.
The customer: pet owners aged 25-45 who care about both their pets and their home aesthetics.
Products must be genuinely useful for pets or pet owners in a home setting.
Think premium pet furniture, stylish bowls, smart feeders, cozy beds, organized pet supply storage.
"""
